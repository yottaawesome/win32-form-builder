		...
		Win32::WPARAM wParam, Win32::LPARAM lParam) -> Win32::LRESULT
	{
		...
		case Win32::Messages::Command:
		{
			...
			case IDM_TOOLS_CHECKA11Y:
			{
				...
				if (warnings.empty())
				{
					FormDesigner::ShowInfo(hwnd, L"No accessibility issues found.",
				...
				else
				{
					...
					FormDesigner::ShowWarning(hwnd, msg, L"Accessibility Check");
				}
				return 0;
			}
			...
			default:
			{
				// Dynamic recent files menu items.
